...
-- Составные индексы для быстрых фильтров
CREATE INDEX idx_recipes_lang ON recipes(lang);
CREATE INDEX idx_recipe_ingredients_recipe_ingredient ON recipe_ingredients(recipe_id, ingredient_id);
CREATE INDEX idx_recipe_diets_recipe_diet ON recipe_diets(recipe_id, diet_id);
CREATE INDEX idx_recipe_meal_types_recipe_meal ON recipe_meal_types(recipe_id, meal_type_id);
CREATE INDEX idx_recipe_kitchens_recipe_kitchen ON recipe_kitchens(recipe_id, kitchen_id);